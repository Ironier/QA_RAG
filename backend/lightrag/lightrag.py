...
class LightRAG:
    ...
    def get_networkx_kg(
        ...
        """
        Get networkx form of knowledge graph.

        Args:

        Returns:
            str: The knowledge graph in networkx form.
        """
        loop = always_get_an_event_loop()

        return loop.run_until_complete(self.aget_networkx_kg())  # type: ignore

    async def aget_networkx_kg(
        self,
    ) -> nx.MultiDiGraph:
        """
        Get networkx form of knowledge graph.
