...
PROMPTS["DEFAULT_LANGUAGE"] = "Mandarin"
...
- relationship_strength: a numeric score indicating strength of the relationship between the source entity and target entity. 0<=relationship_strength<=10
...
Entity_types: [university, abbreviation, discipline, QS rank, code]
Text:
```
China University of Geoscience(abbreviated as CUG, QS ranking 771-780, Code:002700) is a science and engineering university with earth science as its specialty.
```

Output:
("entity"{tuple_delimiter}"China University of Geoscience"{tuple_delimiter}"university"{tuple_delimiter}"a earth-science-specialized university in China")
("entity"{tuple_delimiter}"science and engineering university"{tuple_delimiter}"university"{tuple_delimiter}"a kind of university with specialty of science and engineering")
("entity"{tuple_delimiter}"CUG"{tuple_delimiter}"abbreviation"{tuple_delimiter}"abbreviation of China University of Geoscience")
("entity"{tuple_delimiter}"earth science"{tuple_delimiter}"discipline"{tuple_delimiter}"arth Science​​ is the study of the Earth and its systems, including its physical composition, processes, and history. It is a broad field that integrates aspects of geology, meteorology, oceanography, astronomy, and environmental science to understand how the Earth works and how it has evolved over time.")
("entity"{tuple_delimiter}"771-780"{tuple_delimiter}"QS rank"{tuple_delimiter}"China University of Geoscience ranks 771-780 in QS")
("entity"{tuple_delimiter}"002700"{tuple_delimiter}"code"{tuple_delimiter}"002700 is the code of CUG")
("relationship"{tuple_delimiter}"China University of Geoscience"{tuple_delimiter}"CUG"{tuple_delimiter}"China University of Geoscience is abbreviated as CUG."{tuple_delimiter}"abbreviated as"{tuple_delimiter}8)
("relationship"{tuple_delimiter}"China University of Geoscience"{tuple_delimiter}"771-780"{tuple_delimiter}"China University of Geoscience ranks 771-780 in QS."{tuple_delimiter}"rank in QS"{tuple_delimiter}6)
("relationship"{tuple_delimiter}"China University of Geoscience"{tuple_delimiter}"002700"{tuple_delimiter}"China University of Geoscience`s code is 002700."{tuple_delimiter}"coded as"{tuple_delimiter}8)
("relationship"{tuple_delimiter}"China University of Geoscience"{tuple_delimiter}"science and engineering university"{tuple_delimiter}"China University of Geoscience is a science and engineering university."{tuple_delimiter}"is"{tuple_delimiter}6)
("relationship"{tuple_delimiter}"China University of Geoscience"{tuple_delimiter}"earth science"{tuple_delimiter}"China University of Geoscience specializes in earth science."{tuple_delimiter}"specializes in"{tuple_delimiter}9.5)
#############################""",
 """Example 5:

Entity_types: [legal term, category, usage]
Text:
```
第n条 本法促进矿产资源合理开发利用
```
...
Output:
("entity"{tuple_delimiter}"第n条"{tuple_delimiter}"legal term"{tuple_delimiter}"法律条款的第n条")
("entity"{tuple_delimiter}"矿产资源"{tuple_delimiter}"category"{tuple_delimiter}"一种以矿物等为主的资源的统称")
("entity"{tuple_delimiter}"合理开发利用"{tuple_delimiter}"usage"{tuple_delimiter}"让资源能在尽量不浪费的情况下尽可能满足人类需求的使用方式")
("relationship"{tuple_delimiter}"本法"{tuple_delimiter}"第一条"{tuple_delimiter}"本法的第一条"{tuple_delimiter}"包含"{tuple_delimiter}9.5)
("relationship"{tuple_delimiter}"本法"{tuple_delimiter}"合理开发利用"{tuple_delimiter}"本法促进矿产资源合理开发利用"{tuple_delimiter}"促进"{tuple_delimiter}9.5)
#############################""",
]
...
- Answers should be as short as possible and in the corresponding sentence structure, without any additional analysis."""
